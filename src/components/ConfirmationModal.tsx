...
export default function ConfirmationModal({ data, threadId, onClose }: ConfirmationModalProps) {
  ...
  const post = async (confirmed: boolean) => {
    setSubmitting(true);
    try {
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      ...
      <div className="relative w-full max-w-md bg-[#080d18] border border-blue-500/20 rounded-lg shadow-2xl overflow-hidden"
        ...
        <div className="px-6 pt-5">
          ...
          {/* LinkedIn data */}
          <div className="mt-4 bg-blue-500/5 border border-blue-500/15 rounded px-3 py-2.5 space-y-3 shadow-inner">
            ...
            <div>
              ...
              {(!fields.sales_nav_url || fields.sales_nav_url.includes('keywords%3A') || !fields.linkedin_org_id) && (
                <div className="mt-1.5 flex items-center gap-1.5 text-amber-400/80">
