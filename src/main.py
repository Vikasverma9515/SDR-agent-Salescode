...
CLI usage:
  python -m src.main fini --companies "Company A,Company B" --sdr "SDR Name" --submit-n8n
  python -m src.main searcher --companies "Company A"
  python -m src.main veri
  python -m src.main status --thread-id <id>
  python -m src.main resume --thread-id <id>
  python -m src.main ui  # Start the web UI server
"""
